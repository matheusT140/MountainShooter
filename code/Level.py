...
from code.Const import COLOR_WHITE, W_HEIGHT
...
class Level:
    def __init__(self, window, name, game_mode):
        ...
        self.timeout = 20000 # 20mil milissegundos ou 20 segundos

    def run(self):
        pygame.mixer_music.load(f'./asset/{self.name}.mp3')
        pygame.mixer_music.play(-1) # parametro para o play ocorrer indefinidamente
